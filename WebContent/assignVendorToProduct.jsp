...
<script type="text/javascript">
	...
	//	var cat_id=document.getElementById("selCat").value;
		window.open("assignVendorToProductIframe.jsp?vendor_id="+vendor_id, "ifrmShowProdBrand");
		//window.open("assignVendorToProductIframe.jsp?vendor_id="+vendor_id+"&cat_id="+cat_id, "ifrmShowProdBrand");
	}
</script>
</head>
<body>
...
<div class="box">
			...
			%>
			<div  style="width: 100%">
			<h2>Assign Vendor To Product</h2>
			...
			<iframe name="ifrmShowProdBrand" width="100%" height="400" src="assignVendorToProductIframe.jsp"></iframe>
