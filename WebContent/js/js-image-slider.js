...
function mcImgSlider(l) {
	...
	}, Hb = document, T = window.requestAnimationFrame, db = window.cancelAnimationFrame, kb = [
			"webkit", "ms", "o" ], cb = 0; cb < kb[e] && !T; ++cb) {
		T = window[kb[cb] + "RequestAnimationFrame"];
	...
	var b = "style", y = "display", F = "visibility", j = "width", z = "height", X = "top", P = "background", r = "undefined", w = "marginLeft", v = "appendChild", q = "parentNode", o = "nodeName", Q = "innerHTML", W = "offsetWidth", C = setTimeout, K = clearTimeout, E = "indexOf", N = "setAttribute", jb = "removeChild", D = function() {
		...
		if ((c = a[E]("MSIE ")) != -1)
			b = parseInt(a.substring(c + 5, a[E](".", c)));
		if (a[E]("Safari") != -1 && a[E]("Chrome") == -1)
			b = 300;
		if (a[E]("Opera") != -1)
			b = 400;
		return b;
		...
		if (a) {
			a.o = c;
			if (bb)
				a[b].filter = "alpha(opacity=" + c * 100 + ")";
			else
				a[b][i] = c;
		}
	};
	...
	var k = new D, ob = function() {
		...
		if (b == "series1")
			...
			a.a = b.split(/\W+/);
		a.a.p = l.effectRandom ? -1 : a.a[e] == 1 ? 0 : 1;
	}, fb = function() {
		a = {
			b : l.pauseTime,
			c : l.transitionTime,
			...
			i : l.autoAdvance,
			j : l.captionOpacity,
			k : l.captionEffect == "none" ? 0 : l.captionEffect == "fade" ? 1
					: 2,
			l : l.thumbnailsWrapperId,
			Ob : function() {
		...
		if (g)
			a.m = Math.ceil(g.offsetHeight * a.g / g[W]);
		qb(l.effect);
		a.n = function() {
			var b;
			if (a.a.p == -1)
				b = a.a[Math.floor(Math.random() * a.a[e])];
			else {
				b = a.a[a.a.p];
				a.a.p++;
				if (a.a.p >= a.a[e])
		...
		var a = 0, b = 0, c;
		while (a < d.length) {
			c = d[a][f] == "lazyImage" || d[a][h]("data-src")
					|| d[a][f][E](" video") > -1 && typeof McVideo != r;
			if (c) {
				b = 1;
				break;
			}
		...
		if (a)
			while (a--)
				x[a][f] = a != b && x[a].on == 0 ? "thumb" : "thumb thumb-on";
	}, zb = function(a) {
		var b = a[q][h]("data-autovideo") == "true", c = a[h]("data-autovideo") == "true";
		return b || c;
	}, Bb = function() {
		var g;
		if (a.l)
			g = Y(a.l);
		if (g)
			for ( var h = lb(g, "*"), d = 0; d < h[e]; d++)
				h[d][f] == "thumb" && x.push(h[d]);
		var b = x[e];
		if (b) {
			while (b--) {
				x[b].on = 0;
				...
				x[b].onmouseover = function() {
					this.on = 1;
					this[f] = "thumb thumb-on";
					a.h == 2 && sb();
				};
				x[b].onmouseout = function() {
					this.on = 0;
					this[f] = this.i == c.a ? "thumb thumb-on" : "thumb";
					a.h == 2 && pb();
				};
			}
			rb(0);
		...
		C(function() {
			if (e && g == e - 1) {
				...
				f = a;
			typeof b[j] !== r && k.r(c, "width", b[j], d[j], a);
			typeof b[z] !== r && k.r(c, "height", b[z], d[z], a);
			k.r(c, i, b[i], d[i], f);
		}, f);
	}, tb = function(a) {
		g = a;
		...
		for ( var b = [], a = 0; a < d[e]; a++)
			b[b[e]] = String.fromCharCode(d.charCodeAt(a) - (c ? c : 3));
		return b.join("");
	}, wb = [ /(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/,
			/.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/,
	...
	tb.prototype = {
		c : function() {
			...
			if (l[n - 1][f] == "loading")
				return;
			this.M(a.d);
			var r = /\/?(SOURCE|EMBED|OBJECT|\/VIDEO|\/AUDIO)/, i, j;
			d = [];
			while (n--) {
				i = l[n];
				j = 0;
				if (i[o] == "BR" || bb && r.test(i[o]))
					g[jb](i);
				else {
					i[b][y] = "none";
			...
			if (hb() == 300)
				g[b]["-webkit-transform"] = "translate3d(0,0,0)";
		},
		b : function(a) {
			if (typeof McVideo != r) {
				a.onclick = function() {
		...
		d : function(b) {
			var a = McVideo.play(b, u, B, this.Id);
			if (a)
				c.b = 2;
			return false;
		},
		f : function() {
			...
			for ( var i = [], a = 0; a < c.d; a++)
				i.push("<div rel='" + a + "'>" + (a + 1) + "</div>");
			S[Q] = i.join("");
			for ( var d = H(S), a = 0; a < d[e]; a++) {
				if (a == c.a)
					d[a][f] = "active";
		...
		g : function() {
			...
			while (a--) {
				if (a == c.a)
					...
					e[a][f] = "";
				if (d[a][o] == "A" || d[a][f] == "video")
					d[a][b][y] = a == c.a ? "block" : "none";
			}
		},
		i : function() {
			O = A("mc-caption");
			...
			p[v](O);
			M(p, 0);
			p[b][F] = n[b][F] = V[b][F] = "hidden";
			g[v](n);
			g[v](p);
			Z = [ n.offsetLeft, n.offsetTop, O[W] ];
			O[b][j] = V[b][j] = O[W] + "px";
			this.j();
		},
		j : function() {
		...
		l : function() {
			...
			if (O[Q][e] > 1)
				if (!a.k)
					...
					if (typeof t[w] !== r) {
						k.r(p, "width", t[j], J[j], c);
						k.r(n, "width", I[j], G[j], c);
						k.r(p, "marginLeft", t[w], J[w], c);
						k.r(n, "marginLeft", I[w], G[w], c);
					}
					if (typeof t[i] !== r) {
						k.r(p, i, t[i], J[i], c);
						k.r(n, i, I[i], G[i], f);
		...
		m : function() {
			...
			if (U) {
				...
				if (a.k) {
					...
					if (typeof t[w] !== r) {
						k.r(p, "width", J[j], t[j], c);
						k.r(n, "width", G[j], I[j], c);
						k.r(p, "marginLeft", J[w], t[w], c);
						k.r(n, "marginLeft", G[w], I[w], c);
					}
					if (typeof t[i] !== r) {
						k.r(p, i, J[i], t[i], c);
						k.r(n, i, G[i], I[i], c);
		...
		o : function() {
			...
			s = null;
			g[b][P] = 'url("' + c.e[h]("src") + '")';
			var j = this, d = c.e[q], i;
			if (i = d.aP || eb && /video$/.test(d[f])) {
				this.d(d);
				if (i == 1)
					d.aP = 0;
			} else if (!c.b && a.i) {
		...
		e : function(j) {
			var a = d[j], k = 0;
			if (a[o] == "A" && a[f][E]("lazyImage") == -1 || a[o] == "DIV"
					&& a[f] == "video") {
				a = H(a)[0];
				k = 1;
			}
			if (a[o] != "IMG") {
				if (a[o] == "A")
					var e = a[h]("href"), g = a[h]("title") || "", i = 1;
		...
		p : function(i) {
			...
			if (!L) {
				...
				g[v](L);
				if (hb() >= 300)
					g[b].borderRadius = L[b].borderRadius = "0px";
			}
			L[Q] = "";
			var e = i ? i : a.n();
			a.Ob.apply(this, [ c.a, c.e, U, e ]);
			rb(c.a);
			var f = e < 14 ? this.w(e) : this.x();
			if (e < 9 || e == 15) {
				if (e % 2)
					f = f.reverse();
			} else if (e < 14)
		...
		v : function() {
			...
			return (new Function(
					...
					.apply(this, [ a, Db, d, Bb, wb, yb, 0, xb, function(a) {
						return Hb[a];
					}, H, vb, g ]);
		},
		w : function(g) {
			for ( var k = [], i = g > 8 ? u : Math.round(u / a.f), l = g > 8 ? 1
					: a.f, f = 0; f < l; f++) {
				var d = A("mcSlc");
				d[b].left = i * f + "px";
				d[b][j] = (f == a.f - 1 ? u - i * f : i) + "px";
				d[b][z] = "0px";
				d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat -' + f * i
						+ "px 0%";
				if (g == 10)
					d[b][P] = 'url("' + c.e[h]("src")
							+ '") no-repeat right top';
		...
		x : function() {
			for ( var k = [], i = Math.round(u / a.g), g = Math.round(B / a.m), f = 0; f < a.m; f++)
				for ( var e = 0; e < a.g; e++) {
					var d = A("mcBox");
					d[b].left = i * e + "px";
					d[b][X] = g * f + "px";
					...
					d[b][j] = d.w + "px";
					d[b][z] = d.h + "px";
					d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat -' + e
							* i + "px -" + f * g + "px";
					d[b].zIndex = 1;
					d[b].position = "absolute";
					M(d, 0);
